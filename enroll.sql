...
CREATE TABLE `activity` (
  ...
  `start_time` varchar(20) DEFAULT NULL COMMENT '报名开始时间',
  `end_time` varchar(20) DEFAULT NULL COMMENT '报名截至时间',
  `version` bigint(11) DEFAULT '0' COMMENT '版本号',
  `max_user` int(11) DEFAULT '0' COMMENT '最大报名人数',
  `img` varchar(255) DEFAULT NULL COMMENT '活动介绍图',
  `pay` double(10,2) DEFAULT '0.00' COMMENT '活动报名费',
  `act_start` varchar(20) DEFAULT NULL COMMENT '活动开始时间',
  `act_end` varchar(20) DEFAULT NULL COMMENT '活动结束时间',
  `address` varchar(64) DEFAULT NULL COMMENT '活动地址',
  `longitude` varchar(64) DEFAULT NULL COMMENT '活动地址经度',
  `latitude` varchar(64) DEFAULT NULL COMMENT '活动地址维度',
  `share` int(11) DEFAULT '0' COMMENT '分享人数',
  `link_phone` varchar(20) DEFAULT NULL COMMENT '联系人电话',
  `link_name` varchar(32) DEFAULT NULL COMMENT '联系人姓名',
  `link_wx` varchar(32) DEFAULT NULL COMMENT '联系人微信',
  `user_id` varchar(32) DEFAULT NULL COMMENT '发起人id',
  `create_by` varchar(32) DEFAULT NULL COMMENT '创建人',
  `update_by` varchar(32) DEFAULT NULL COMMENT '修改人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  `del_flag` tinyint(1) DEFAULT '0' COMMENT '删除标识0-正常,1-已删除',
  `cur_user` int(11) DEFAULT '0' COMMENT '当前人数（已报名人数）',
  `status` int(11) DEFAULT '1' COMMENT '状态 1 报名中 2结束报名 3取消报名',
  `permission` int(11) DEFAULT '1' COMMENT '数据可见性 1管理员可见 2报名人员可见 3任何人可见',
  `show_type` int(11) DEFAULT '1' COMMENT '报名列表显示 1人数头像昵称 2人数头像 3人数 4什么都不显示',
  PRIMARY KEY (`id`)
...
-- Records of activity
-- ----------------------------
INSERT INTO `activity` VALUES ('0a70e5f83c5f44aea5544fe288bd392e', '周杰伦', '2019/09/17 18:00:00', '2019/09/19 18:00:00', '3', '10', 'https://test.zhenyangzixun.com/enroll/image/1568715683701.jpg', '0.00', '', '', '广东省深圳市南山区兰香一街与兰桂二街交叉路口东北方50米处', '113.93991', '22.506618', '0', null, '陈京桥', '', 'f578d768c35110563ec3c9bec0c522bb', 'jeecg', 'jeecg', '2019-09-17 18:12:00', '2019-09-18 09:36:52', '0', '2', '1', '1', '1');
INSERT INTO `activity` VALUES ('33c4369536374834947bbd76bb0e52a2', '9.19再测一次', '2019/09/18 17:00:00', '2019/09/19 17:00:00', '1', '20', 'https://test.zhenyangzixun.com/enroll/image/1568801064133.jpg', '0.00', '2019/09/19 17:00:00', '2019/09/20 17:00:00', '君尚3019(南山区中心路3019号)', '113.94003', '22.506237', '0', null, 'ꫛꫀꪝ', '', '471b516b2a17faeb2f7a7786806f942b', 'jeecg', null, '2019-09-18 17:58:01', null, '0', '0', '1', '1', '1');
INSERT INTO `activity` VALUES ('435393465af34dcc852489a503c64400', '一次过', '2019/09/17 17:00:00', '2019/09/19 17:00:00', '1', '10', 'https://test.zhenyangzixun.com/enroll/image/1568714372680.png', '0.00', '2019/09/18 17:00:00', '2019/09/19 17:00:00', '广东省深圳市南山区南海大道3688号', '113.93664', '22.532323', '0', null, '陈京桥', '', null, 'jeecg', null, '2019-09-17 17:47:22', null, '0', '0', '1', '1', '1');
INSERT INTO `activity` VALUES ('75648a32824a4afe8790b83682ab88d0', '最后一次', '2019/09/18 18:00:00', '2019/09/19 18:00:00', '2', '20', 'https://test.zhenyangzixun.com/enroll/image/1568715601107.jpg', '0.00', '2019/09/18 18:00:00', '2019/09/19 18:00:00', '天虹商场总部大厦(深圳市南山区)', '113.94026', '22.506369', '0', null, 'ꫛꫀꪝ', '', '471b516b2a17faeb2f7a7786806f942b', 'jeecg', 'jeecg', '2019-09-17 18:05:59', '2019-09-17 18:06:58', '0', '1', '1', '1', '1');
INSERT INTO `activity` VALUES ('8c9b9f408a24433291a505b79aff7d9d', '测试', '2019/09/17 17:00:00', '2019/09/20 17:00:00', '1', '30', 'https://test.zhenyangzixun.com/enroll/image/1568713988039.jpg', '0.00', '2019/09/17 17:00:00', '2019/09/17 17:00:00', '天虹商场总部大厦(深圳市南山区)', '113.940346', '22.50637', '0', null, 'ꫛꫀꪝ', '1', '471b516b2a17faeb2f7a7786806f942b', 'jeecg', null, '2019-09-17 17:38:08', null, '0', '0', '1', '1', '1');
INSERT INTO `activity` VALUES ('8ce38acaf98e4781a1027f1235563860', '周杰伦', '2019/09/17 18:00:00', '2019/09/19 18:00:00', '2', '10', 'https://test.zhenyangzixun.com/enroll/image/1568715683701.jpg', '0.00', '', '', '广东省深圳市南山区兰香一街与兰桂二街交叉路口东北方50米处', '113.93991', '22.506618', '0', null, '陈京桥', '', 'f578d768c35110563ec3c9bec0c522bb', 'jeecg', 'jeecg', '2019-09-17 18:11:58', '2019-09-18 15:49:45', '0', '1', '1', '1', '1');
INSERT INTO `activity` VALUES ('a3d1aa1463fc4d6387b8f57be0ff95e8', '测试', '2019/09/17 17:00:00', '2019/09/20 17:00:00', '1', '30', 'https://test.zhenyangzixun.com/enroll/image/1568713988039.jpg', '0.00', '2019/09/17 17:00:00', '2019/09/17 17:00:00', '天虹商场总部大厦(深圳市南山区)', '113.940346', '22.50637', '0', null, 'ꫛꫀꪝ', '1', '471b516b2a17faeb2f7a7786806f942b', 'jeecg', null, '2019-09-17 17:37:56', null, '0', '0', '1', '1', '1');
INSERT INTO `activity` VALUES ('b1bbbfb4542e46faafb4b59de0682ae2', '一次过了哦', '2019/09/17 17:00:00', '2019/09/19 17:00:00', '2', '10', 'https://test.zhenyangzixun.com/enroll/image/1568714735584.png', '0.00', '2019/09/25 17:00:00', '2019/09/26 17:00:00', '广东省深圳市南山区南海大道3688号', '113.93664', '22.532323', '0', null, '陈京桥', '', 'f578d768c35110563ec3c9bec0c522bb', 'jeecg', 'jeecg', '2019-09-17 17:54:14', '2019-09-17 18:06:51', '0', '1', '1', '1', '1');
INSERT INTO `activity` VALUES ('c1d389266d7e4a93b0801351a9857608', '周杰伦', '2019/09/17 18:00:00', '2019/09/19 18:00:00', '1', '10', 'https://test.zhenyangzixun.com/enroll/image/1568715683701.jpg', '0.00', '', '', '广东省深圳市南山区兰香一街与兰桂二街交叉路口东北方50米处', '113.93991', '22.506618', '0', null, '陈京桥', '', 'f578d768c35110563ec3c9bec0c522bb', 'jeecg', null, '2019-09-17 18:11:55', null, '0', '0', '1', '1', '1');
INSERT INTO `activity` VALUES ('d31c3914348a44df8d61fe130379a272', '爬山', '2019/09/18 17:00:00', '2019/09/19 17:00:00', '1', '20', 'https://test.zhenyangzixun.com/enroll/image/1568713728318.jpg', '0.00', '2019/09/18 17:00:00', '2019/09/19 17:00:00', '天虹商场总部大厦(深圳市南山区)', '113.94033', '22.506414', '0', null, 'ꫛꫀꪝ', '', null, 'jeecg', null, '2019-09-17 17:46:05', null, '0', '0', '1', '1', '1');
INSERT INTO `activity` VALUES ('d5ef6537e57a4466b5eba4151e3c5b1b', '周杰伦', '2019/09/17 18:00:00', '2019/09/19 18:00:00', '1', '10', 'https://test.zhenyangzixun.com/enroll/image/1568715683701.jpg', '0.00', '', '', '广东省深圳市南山区兰香一街与兰桂二街交叉路口东北方50米处', '113.93991', '22.506618', '0', null, '陈京桥', '', 'f578d768c35110563ec3c9bec0c522bb', 'jeecg', null, '2019-09-17 18:11:54', null, '0', '0', '1', '1', '1');
INSERT INTO `activity` VALUES ('fd9038b350f846eeaa60179f70eda3a0', '周杰伦', '2019/09/17 18:00:00', '2019/09/19 18:00:00', '2', '10', 'https://test.zhenyangzixun.com/enroll/image/1568715683701.jpg', '0.00', '', '', '广东省深圳市南山区兰香一街与兰桂二街交叉路口东北方50米处', '113.93991', '22.506618', '0', null, '陈京桥', '', 'f578d768c35110563ec3c9bec0c522bb', 'jeecg', 'jeecg', '2019-09-17 18:11:49', '2019-09-17 18:12:40', '0', '1', '1', '1', '1');
...
-- ----------------------------
-- Records of act_content
-- ----------------------------
INSERT INTO `act_content` VALUES ('053a5103a03555a537235d771fc32ea7', '435393465af34dcc852489a503c64400', '[{\"type\":\"text\",\"content\":\"一次过啊\"},{\"type\":\"img\",\"content\":\"https://test.zhenyangzixun.com/enroll/image/1568713630774.png\"}]', 'jeecg', null, '2019-09-17 17:47:22', null, '0');
INSERT INTO `act_content` VALUES ('334cf8cd66a37449f483c69a41129cf1', 'fd9038b350f846eeaa60179f70eda3a0', '[{\"type\":\"text\",\"content\":\"周杰伦牛逼\"},{\"type\":\"img\",\"content\":\"https://test.zhenyangzixun.com/enroll/image/1568715981225.jpg\"}]', 'jeecg', null, '2019-09-17 18:11:49', null, '0');
INSERT INTO `act_content` VALUES ('33daa99e98de94e83037c4d296d6e048', 'c1d389266d7e4a93b0801351a9857608', '[{\"type\":\"text\",\"content\":\"周杰伦牛逼\"},{\"type\":\"img\",\"content\":\"https://test.zhenyangzixun.com/enroll/image/1568715981225.jpg\"}]', 'jeecg', null, '2019-09-17 18:11:55', null, '0');
INSERT INTO `act_content` VALUES ('40af02f81a48a5dc881876f7f8a000df', '75648a32824a4afe8790b83682ab88d0', '[{\"type\":\"text\",\"content\":\"最后一次\"}]', 'jeecg', 'jeecg', '2019-09-17 18:05:59', '2019-09-17 18:06:58', '0');
INSERT INTO `act_content` VALUES ('48404196f132f829f590ae10757be957', 'a3d1aa1463fc4d6387b8f57be0ff95e8', '[{\"type\":\"text\",\"content\":\"测试\"}]', 'jeecg', null, '2019-09-17 17:37:56', null, '0');
INSERT INTO `act_content` VALUES ('4e9ec649820262d079240b2b57f8f25a', '8ce38acaf98e4781a1027f1235563860', '[{\"type\":\"text\",\"content\":\"周杰伦牛逼\"},{\"type\":\"img\",\"content\":\"https://test.zhenyangzixun.com/enroll/image/1568715981225.jpg\"}]', 'jeecg', null, '2019-09-17 18:11:58', null, '0');
INSERT INTO `act_content` VALUES ('5acd36602b293a2c3fc8c1def4e34f8d', '33c4369536374834947bbd76bb0e52a2', '[{\"type\":\"text\",\"content\":\"来嘛 报名试试\"}]', 'jeecg', null, '2019-09-18 17:58:01', null, '0');
INSERT INTO `act_content` VALUES ('9e631cf06bd0f1d6d98f7b7c495ee4dc', 'd31c3914348a44df8d61fe130379a272', '[{\"type\":\"text\",\"content\":\"爬山\"}]', 'jeecg', null, '2019-09-17 17:46:05', null, '0');
INSERT INTO `act_content` VALUES ('da4f37f7aa844385e438dacb323ad61b', '8c9b9f408a24433291a505b79aff7d9d', '[{\"type\":\"text\",\"content\":\"测试\"}]', 'jeecg', null, '2019-09-17 17:38:08', null, '0');
INSERT INTO `act_content` VALUES ('eb4c8ed27ebc31210f3194a24abe334f', 'd5ef6537e57a4466b5eba4151e3c5b1b', '[{\"type\":\"text\",\"content\":\"周杰伦牛逼\"},{\"type\":\"img\",\"content\":\"https://test.zhenyangzixun.com/enroll/image/1568715981225.jpg\"}]', 'jeecg', null, '2019-09-17 18:11:54', null, '0');
INSERT INTO `act_content` VALUES ('fb5da59c48702a77cb6f0861710072b3', '0a70e5f83c5f44aea5544fe288bd392e', '[{\"type\":\"text\",\"content\":\"周杰伦牛逼\"},{\"type\":\"img\",\"content\":\"https://test.zhenyangzixun.com/enroll/image/1568715981225.jpg\"}]', 'jeecg', null, '2019-09-17 18:12:00', null, '0');
INSERT INTO `act_content` VALUES ('fe68192d9bda18127fa0b59a40bea792', 'b1bbbfb4542e46faafb4b59de0682ae2', '[{\"type\":\"text\",\"content\":\"报名抢盆景\"},{\"type\":\"img\",\"content\":\"https://test.zhenyangzixun.com/enroll/image/1568714017801.png\"}]', 'jeecg', null, '2019-09-17 17:54:14', null, '0');

-- ----------------------------
-- Table structure for act_dict
-- ----------------------------
DROP TABLE IF EXISTS `act_dict`;
CREATE TABLE `act_dict` (
  `id` varchar(32) NOT NULL COMMENT 'ID',
  `name` varchar(32) DEFAULT NULL COMMENT '键',
  `detail` varchar(32) DEFAULT NULL COMMENT '介绍',
  `version` bigint(11) DEFAULT '0' COMMENT '版本号',
  `type` varchar(32) DEFAULT 'input' COMMENT '类型(单行文本，多行文本等)',
  `regular` varchar(128) DEFAULT NULL COMMENT '正则表达式',
  `create_by` varchar(32) DEFAULT NULL COMMENT '创建人',
  `update_by` varchar(32) DEFAULT NULL COMMENT '修改人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  `del_flag` tinyint(1) DEFAULT '0' COMMENT '删除标识0-正常,1-已删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='活动字典表\r\n';

-- ----------------------------
-- Records of act_dict
-- ----------------------------
INSERT INTO `act_dict` VALUES ('18006b95bdce3edd78594a5662f753fa', '电话', '请输入电话', '1', 'input', '', 'jeecg', null, '2019-09-17 17:26:15', null, '0');
INSERT INTO `act_dict` VALUES ('3016cce22279cc5b365bd8a2f8ddce0d', '微信号', '您的微信号', '1', 'input', '', 'jeecg', null, '2019-09-17 17:44:22', null, '0');
INSERT INTO `act_dict` VALUES ('75068f359bb57e803be21cbf9b96acad', '姓名', '您的真实姓名', '1', 'input', '', 'jeecg', null, '2019-09-17 17:25:59', null, '0');

-- ----------------------------
-- Table structure for act_form_id
-- ----------------------------
DROP TABLE IF EXISTS `act_form_id`;
CREATE TABLE `act_form_id` (
  `id` varchar(32) NOT NULL COMMENT 'ID',
  `act_id` varchar(32) DEFAULT NULL COMMENT '活动id',
  ...
  `del_flag` tinyint(1) DEFAULT '0' COMMENT '删除标识0-正常,1-已删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='活动formid表\r\n';

-- ----------------------------
-- Records of act_form_id
-- ----------------------------

-- ----------------------------
-- Table structure for act_join_group
-- ----------------------------
DROP TABLE IF EXISTS `act_join_group`;
CREATE TABLE `act_join_group` (
  `id` varchar(32) NOT NULL COMMENT 'ID',
  `act_id` varchar(32) DEFAULT NULL COMMENT '活动id',
  `group_icon` varchar(255) DEFAULT NULL COMMENT '群图标',
  `group_name` varchar(32) DEFAULT NULL COMMENT '群名称',
  `detail` varchar(255) DEFAULT NULL COMMENT '描述',
  `qr_code` varchar(255) DEFAULT NULL COMMENT '群二维码',
  `version` bigint(11) DEFAULT '0' COMMENT '版本号',
  `permission` int(11) DEFAULT '1' COMMENT '数据可见性 1管理员可见 2报名人员可见 3任何人可见',
  `create_by` varchar(32) DEFAULT NULL COMMENT '创建人',
  `update_by` varchar(32) DEFAULT NULL COMMENT '修改人',
  ...
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  `del_flag` tinyint(1) DEFAULT '0' COMMENT '删除标识0-正常,1-已删除',
  `group_type` tinyint(1) DEFAULT '0' COMMENT '1微信群 2QQ群 3公众号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='活动群\r\n';

-- ----------------------------
-- Records of act_join_group
-- ----------------------------

-- ----------------------------
-- Table structure for act_matter
-- ----------------------------
DROP TABLE IF EXISTS `act_matter`;
CREATE TABLE `act_matter` (
  `id` varchar(32) NOT NULL COMMENT 'ID',
  `act_id` varchar(32) DEFAULT NULL COMMENT '活动id',
  `dict_id` varchar(32) DEFAULT NULL COMMENT '参数id',
  `create_time` varchar(20) DEFAULT '' COMMENT '创建时间',
  `update_time` varchar(20) DEFAULT '' COMMENT '修改时间',
  `version` bigint(11) DEFAULT '0' COMMENT '版本号',
  `del_flag` tinyint(1) DEFAULT '1' COMMENT '删除标识0-正常,1-已删除',
  `is_check` int(2) DEFAULT '1' COMMENT '必填：1，选填：2 ',
  `sort` int(11) unsigned DEFAULT '0' COMMENT '排序',
  `status` int(11) DEFAULT '1' COMMENT '状态 1 待审核 2 审核通过 3未通过（多余字段，不使用）',
  `note` varchar(64) DEFAULT NULL COMMENT '备注',
  `permission` int(11) DEFAULT '1' COMMENT '错误字段 不用',
  `show_type` int(11) DEFAULT '1' COMMENT '错误字段 不用',
  `create_by` varchar(32) DEFAULT NULL COMMENT '创建人',
  `update_by` varchar(32) DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='活动事项表 报名需要哪些字段\r\n';

-- ----------------------------
-- Records of act_matter
-- ----------------------------
INSERT INTO `act_matter` VALUES ('105f008df338d5077c5f5e12323ed67b', 'd5ef6537e57a4466b5eba4151e3c5b1b', '3016cce22279cc5b365bd8a2f8ddce0d', '2019-09-17 18:11', '2019-09-17 18:11', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('1dd2abcbc02cdf637152ea0b3c0d8d8e', '33c4369536374834947bbd76bb0e52a2', '3016cce22279cc5b365bd8a2f8ddce0d', '2019-09-18 17:58', '2019-09-18 17:58', '1', '0', '2', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('1ed416e936df8005270a43de0152779b', 'd31c3914348a44df8d61fe130379a272', '18006b95bdce3edd78594a5662f753fa', '2019-09-17 17:46', '2019-09-17 17:46', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('1eeda21483815e89a9fd50deeeef0f51', 'b1bbbfb4542e46faafb4b59de0682ae2', '18006b95bdce3edd78594a5662f753fa', '2019-09-17 17:54', '2019-09-17 17:54', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('20aa038e903d5afa11f839696952feb6', 'd5ef6537e57a4466b5eba4151e3c5b1b', '18006b95bdce3edd78594a5662f753fa', '2019-09-17 18:11', '2019-09-17 18:11', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('3db71ae5ad55c8249e1632eaf8be03f1', 'fd9038b350f846eeaa60179f70eda3a0', '75068f359bb57e803be21cbf9b96acad', '2019-09-17 18:11', '2019-09-17 18:11', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('3e7b98526730900e8d4c8e9ef0698da6', 'c1d389266d7e4a93b0801351a9857608', '18006b95bdce3edd78594a5662f753fa', '2019-09-17 18:11', '2019-09-17 18:11', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('40926792d6465cc759162f63793399d9', 'a3d1aa1463fc4d6387b8f57be0ff95e8', '18006b95bdce3edd78594a5662f753fa', '2019-09-17 17:37', '2019-09-17 17:37', '1', '0', '1', null, '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('555700c35b247bcda94a583f171a4ddb', '8ce38acaf98e4781a1027f1235563860', '3016cce22279cc5b365bd8a2f8ddce0d', '2019-09-17 18:11', '2019-09-17 18:11', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('58d55c2b0d317a168f6e05d3069c1cce', '0a70e5f83c5f44aea5544fe288bd392e', '75068f359bb57e803be21cbf9b96acad', '2019-09-17 18:12', '2019-09-17 18:12', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('5f271715bd5313ac5d5da8c623764db7', '33c4369536374834947bbd76bb0e52a2', '75068f359bb57e803be21cbf9b96acad', '2019-09-18 17:58', '2019-09-18 17:58', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('5f7ea468b284f361c18bd3f7d3a9d625', '75648a32824a4afe8790b83682ab88d0', '75068f359bb57e803be21cbf9b96acad', '2019-09-17 18:06', '2019-09-17 18:06', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('627d3fa1fc2bccca37ea06e476782b1c', 'fd9038b350f846eeaa60179f70eda3a0', '3016cce22279cc5b365bd8a2f8ddce0d', '2019-09-17 18:11', '2019-09-17 18:11', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('6d5b4794c7d93ae8ac9331967b9e589b', '75648a32824a4afe8790b83682ab88d0', '18006b95bdce3edd78594a5662f753fa', '2019-09-17 18:06', '2019-09-17 18:06', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('72b56e70c6b50704c494a844c602fb00', '435393465af34dcc852489a503c64400', '18006b95bdce3edd78594a5662f753fa', '2019-09-17 17:47', '2019-09-17 17:47', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('77e98c04054aabab5b04195a89ba1820', 'fd9038b350f846eeaa60179f70eda3a0', '18006b95bdce3edd78594a5662f753fa', '2019-09-17 18:11', '2019-09-17 18:11', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('7c7a6c4cb2e2d18917b908ced73de679', '0a70e5f83c5f44aea5544fe288bd392e', '18006b95bdce3edd78594a5662f753fa', '2019-09-17 18:12', '2019-09-17 18:12', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('7c8f02019a62f0a0574247246af9091d', '8ce38acaf98e4781a1027f1235563860', '75068f359bb57e803be21cbf9b96acad', '2019-09-17 18:11', '2019-09-17 18:11', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('839ab784f077d1b8d6ec47d927493e05', '8c9b9f408a24433291a505b79aff7d9d', '18006b95bdce3edd78594a5662f753fa', '2019-09-17 17:38', '2019-09-17 17:38', '1', '0', '1', null, '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('90d7ee33c0347bfcea450d36dd1fb5f3', 'd31c3914348a44df8d61fe130379a272', '3016cce22279cc5b365bd8a2f8ddce0d', '2019-09-17 17:46', '2019-09-17 17:46', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('9d4371dc9dc3455e0b0fd17239935edc', '8c9b9f408a24433291a505b79aff7d9d', '75068f359bb57e803be21cbf9b96acad', '2019-09-17 17:38', '2019-09-17 17:38', '1', '0', '1', null, '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('a691912755b9b72d407b7437661e3e87', '435393465af34dcc852489a503c64400', '75068f359bb57e803be21cbf9b96acad', '2019-09-17 17:47', '2019-09-17 17:47', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('a9d76b4b1ef7b1c34879737e6f215573', 'b1bbbfb4542e46faafb4b59de0682ae2', '3016cce22279cc5b365bd8a2f8ddce0d', '2019-09-17 17:54', '2019-09-17 17:54', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('af7a537bf215be02f92e048d28054546', 'c1d389266d7e4a93b0801351a9857608', '75068f359bb57e803be21cbf9b96acad', '2019-09-17 18:11', '2019-09-17 18:11', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('badf16506c1651bb7c29cb0d8be6d680', 'd31c3914348a44df8d61fe130379a272', '75068f359bb57e803be21cbf9b96acad', '2019-09-17 17:46', '2019-09-17 17:46', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('ca912ac2b0174d959e3e501e9759eb5c', '0a70e5f83c5f44aea5544fe288bd392e', '3016cce22279cc5b365bd8a2f8ddce0d', '2019-09-17 18:12', '2019-09-17 18:12', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('cd5167dd5ff8e3c893f9518b20b438d1', 'c1d389266d7e4a93b0801351a9857608', '3016cce22279cc5b365bd8a2f8ddce0d', '2019-09-17 18:11', '2019-09-17 18:11', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('cf86faae20517de88cc3936108c8eaec', 'd5ef6537e57a4466b5eba4151e3c5b1b', '75068f359bb57e803be21cbf9b96acad', '2019-09-17 18:11', '2019-09-17 18:11', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('d35346379aa973880d37133469873a91', '33c4369536374834947bbd76bb0e52a2', '18006b95bdce3edd78594a5662f753fa', '2019-09-18 17:58', '2019-09-18 17:58', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('deb035cb38a8256d703eb6541182c07e', 'b1bbbfb4542e46faafb4b59de0682ae2', '75068f359bb57e803be21cbf9b96acad', '2019-09-17 17:54', '2019-09-17 17:54', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('dff57df70fcdc1da5d89de12dc448a88', 'a3d1aa1463fc4d6387b8f57be0ff95e8', '75068f359bb57e803be21cbf9b96acad', '2019-09-17 17:37', '2019-09-17 17:37', '1', '0', '1', null, '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('ee5df74370c6c248a6762e97557698ff', '8ce38acaf98e4781a1027f1235563860', '18006b95bdce3edd78594a5662f753fa', '2019-09-17 18:11', '2019-09-17 18:11', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);
INSERT INTO `act_matter` VALUES ('fdc18459fa2c429a55d0df129e906651', '435393465af34dcc852489a503c64400', '3016cce22279cc5b365bd8a2f8ddce0d', '2019-09-17 17:47', '2019-09-17 17:47', '1', '0', '1', '0', '1', null, '1', '1', 'jeecg', null);

-- ----------------------------
-- Table structure for act_matter_value
-- ----------------------------
DROP TABLE IF EXISTS `act_matter_value`;
CREATE TABLE `act_matter_value` (
  `id` varchar(32) NOT NULL COMMENT 'ID',
  `mat_id` varchar(32) DEFAULT NULL COMMENT '必传参数id',
  `mat_value` varchar(64) DEFAULT '' COMMENT '参数值',
  `version` bigint(11) DEFAULT '0' COMMENT '版本号',
  ...
  `del_flag` tinyint(1) DEFAULT '0' COMMENT '删除标识0-正常,1-已删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='报名登记表\r\n';

-- ----------------------------
-- Records of act_matter_value
-- ----------------------------
INSERT INTO `act_matter_value` VALUES ('2e27ac791bbb1afa170f3bd26a04c346', '7c7a6c4cb2e2d18917b908ced73de679', '测试1', '1', '471b516b2a17faeb2f7a7786806f942b', 'jeecg', null, '2019-09-18 10:09:40', null, '0');
INSERT INTO `act_matter_value` VALUES ('465a7b1087659000f850a1222abc9f42', '1eeda21483815e89a9fd50deeeef0f51', '123', '1', 'f578d768c35110563ec3c9bec0c522bb', 'jeecg', null, '2019-09-17 18:06:51', null, '0');
INSERT INTO `act_matter_value` VALUES ('4d4f2e45d409ff66faf4f437786466b9', '6d5b4794c7d93ae8ac9331967b9e589b', '1111', '1', '471b516b2a17faeb2f7a7786806f942b', 'jeecg', null, '2019-09-17 18:07:20', null, '0');
INSERT INTO `act_matter_value` VALUES ('5e1793ed30a786fa379cf0a6667ce3fe', 'deb035cb38a8256d703eb6541182c07e', '22', '1', 'f578d768c35110563ec3c9bec0c522bb', 'jeecg', null, '2019-09-17 18:06:51', null, '0');
INSERT INTO `act_matter_value` VALUES ('5e6a368c8d19d30a8d0dca71587be8aa', '5f7ea468b284f361c18bd3f7d3a9d625', '1111', '1', '471b516b2a17faeb2f7a7786806f942b', 'jeecg', null, '2019-09-17 18:07:20', null, '0');
INSERT INTO `act_matter_value` VALUES ('5ffea7b64e8c884f887a1fb76e72cc19', '3db71ae5ad55c8249e1632eaf8be03f1', '呵呵呵', '1', 'f578d768c35110563ec3c9bec0c522bb', 'jeecg', null, '2019-09-17 18:12:40', null, '0');
INSERT INTO `act_matter_value` VALUES ('73a5c553c37b3eba64df310424ac62d0', '58d55c2b0d317a168f6e05d3069c1cce', '陈京桥', '1', 'f578d768c35110563ec3c9bec0c522bb', 'jeecg', null, '2019-09-18 09:36:52', null, '0');
INSERT INTO `act_matter_value` VALUES ('7768ccf755813e971055601415cea923', 'ca912ac2b0174d959e3e501e9759eb5c', '测试1', '1', '471b516b2a17faeb2f7a7786806f942b', 'jeecg', null, '2019-09-18 10:09:40', null, '0');
INSERT INTO `act_matter_value` VALUES ('7a3c6c8bce3a0fbd89d601b86bc80c71', '627d3fa1fc2bccca37ea06e476782b1c', '啦啦啦', '1', 'f578d768c35110563ec3c9bec0c522bb', 'jeecg', null, '2019-09-17 18:12:40', null, '0');
INSERT INTO `act_matter_value` VALUES ('88570c5bd3bed4c5ac6bc78daa46d6d8', '77e98c04054aabab5b04195a89ba1820', '哈哈哈', '1', 'f578d768c35110563ec3c9bec0c522bb', 'jeecg', null, '2019-09-17 18:12:40', null, '0');
INSERT INTO `act_matter_value` VALUES ('96f323fd7e7318a3d776c6a470eb2375', 'ca912ac2b0174d959e3e501e9759eb5c', 'ccc', '1', 'f578d768c35110563ec3c9bec0c522bb', 'jeecg', null, '2019-09-18 09:36:52', null, '0');
INSERT INTO `act_matter_value` VALUES ('9e95e6e7d3e20ac58ecaafa74165fe41', '58d55c2b0d317a168f6e05d3069c1cce', '测试', '1', '471b516b2a17faeb2f7a7786806f942b', 'jeecg', null, '2019-09-18 10:09:40', null, '0');
INSERT INTO `act_matter_value` VALUES ('a1595f205cdbb7bd7e176d867d87b1ff', '555700c35b247bcda94a583f171a4ddb', '2', '1', 'f578d768c35110563ec3c9bec0c522bb', 'jeecg', null, '2019-09-18 15:49:45', null, '0');
INSERT INTO `act_matter_value` VALUES ('afa79334c126ae9cb7c2f6cbfca28fd2', 'a9d76b4b1ef7b1c34879737e6f215573', '1123', '1', 'f578d768c35110563ec3c9bec0c522bb', 'jeecg', null, '2019-09-17 18:06:51', null, '0');
INSERT INTO `act_matter_value` VALUES ('afe12b10cddc42c5b1f7d1163166cb82', '7c7a6c4cb2e2d18917b908ced73de679', '18202330094', '1', 'f578d768c35110563ec3c9bec0c522bb', 'jeecg', null, '2019-09-18 09:36:52', null, '0');
INSERT INTO `act_matter_value` VALUES ('ea2ca99c361807674c0b9a1b966160ef', '7c8f02019a62f0a0574247246af9091d', '3', '1', 'f578d768c35110563ec3c9bec0c522bb', 'jeecg', null, '2019-09-18 15:49:45', null, '0');
INSERT INTO `act_matter_value` VALUES ('f3d9741038de55d18635e7472dc858cf', 'ee5df74370c6c248a6762e97557698ff', '1', '1', 'f578d768c35110563ec3c9bec0c522bb', 'jeecg', null, '2019-09-18 15:49:45', null, '0');

-- ----------------------------
-- Table structure for act_msg
-- ----------------------------
...
CREATE TABLE `act_msg` (
  ...
  `update_by` varchar(32) DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='活动消息';
...
-- ----------------------------
-- Table structure for act_pay
-- ----------------------------
DROP TABLE IF EXISTS `act_pay`;
CREATE TABLE `act_pay` (
  `id` varchar(32) NOT NULL COMMENT 'ID',
  `act_id` varchar(32) DEFAULT NULL COMMENT '活动id',
  `order_no` varchar(40) DEFAULT NULL COMMENT '订单号',
  `user_id` varchar(32) DEFAULT NULL COMMENT '用户id',
  `pay` double(10,2) DEFAULT '0.00' COMMENT '支付',
  `version` bigint(11) DEFAULT '0' COMMENT '版本号',
  `pay_type` int(2) DEFAULT '1' COMMENT '支付方式 1 微信 2支付宝',
  `create_by` varchar(32) DEFAULT NULL COMMENT '创建人',
  `update_by` varchar(32) DEFAULT NULL COMMENT '修改人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  `del_flag` tinyint(1) DEFAULT '0' COMMENT '删除标识0-正常,1-已删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='报名支付表\r\n';
...
CREATE TABLE `act_share` (
  `id` varchar(32) NOT NULL COMMENT 'ID',
  `act_id` varchar(32) DEFAULT NULL COMMENT '活动id',
  `user_id` varchar(32) DEFAULT NULL COMMENT '分享活动的用户id',
  `invite_id` varchar(32) DEFAULT NULL COMMENT '被邀请用户id',
  `version` bigint(11) DEFAULT '0' COMMENT '版本号',
  `create_by` varchar(32) DEFAULT NULL COMMENT '创建人',
  `update_by` varchar(32) DEFAULT NULL COMMENT '修改人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  `reward` double(10,2) DEFAULT '0.00' COMMENT '分享活动奖励金',
  `del_flag` tinyint(1) DEFAULT '0' COMMENT '删除标识0-正常,1-已删除',
  `share_type` tinyint(1) DEFAULT '0' COMMENT '1朋友圈 2分享给好友 3生成二维码分享 4复制链接',
  `num` int(11) DEFAULT '0' COMMENT '分享点击数',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `act_share` VALUES ('70b4d7e90787cace2c7a1503929f8a53', '0a70e5f83c5f44aea5544fe288bd392e', 'f578d768c35110563ec3c9bec0c522bb', '471b516b2a17faeb2f7a7786806f942b', '0', 'jeecg', null, '2019-09-18 10:09:40', null, '0.00', '0', '1', '0');
...
CREATE TABLE `act_user` (
  ...
  `openid` varchar(45) DEFAULT NULL COMMENT 'openid',
  `phone` varchar(45) DEFAULT NULL COMMENT '电话',
  `type` int(10) DEFAULT '1' COMMENT '1注册用户 2小程序管理员',
...
-- Records of act_user
-- ----------------------------
INSERT INTO `act_user` VALUES ('471b516b2a17faeb2f7a7786806f942b', 'ꫛꫀꪝ', null, null, 'https://wx.qlogo.cn/mmopen/vi_32/X0zwe8n2DicaEz6eRxWHUWvNxBzomslQOibuWWBa7vmcg5icRfhJrewLHbOd7Lz1YMhSwqsxz8V91DNPIf0eQGxSg/132', '1', 'oGA7d4l5O9XuJXwongd9CSD0gTi8', '17783549100', '2', '1', 'jeecg', 'jeecg', '2019-09-17 17:23:37', '2019-09-17 17:23:43', '0');
INSERT INTO `act_user` VALUES ('f578d768c35110563ec3c9bec0c522bb', '陈京桥', null, null, 'https://wx.qlogo.cn/mmopen/vi_32/XNSGdUXGr5icEmucR0N3XgGhBJ16EUJXX87IsIXzu9kveu9CMzsY5EIk3ePicllG97E9UhUic8dhIPh2BmeVRmXRw/132', '1', 'oGA7d4pfprDeAtymRGxv_hAzb5i8', '18202330094', '2', '1', 'jeecg', 'jeecg', '2019-09-17 17:23:53', '2019-09-17 17:25:32', '0');

-- ----------------------------
-- Table structure for act_user_record
-- ----------------------------
DROP TABLE IF EXISTS `act_user_record`;
CREATE TABLE `act_user_record` (
  `id` varchar(32) NOT NULL COMMENT 'ID',
  `act_id` varchar(32) DEFAULT NULL COMMENT '活动id',
  `user_id` varchar(32) DEFAULT '' COMMENT '用户id',
  `version` bigint(11) DEFAULT '0' COMMENT '版本号',
  `status` int(11) DEFAULT '1' COMMENT '状态 1 待审核 2 审核通过 3未通过',
  `create_by` varchar(32) DEFAULT NULL COMMENT '创建人',
  `update_by` varchar(32) DEFAULT NULL COMMENT '修改人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  `del_flag` tinyint(1) DEFAULT '0' COMMENT '删除标识0-正常,1-已删除',
  `is_arrived` tinyint(1) DEFAULT '1' COMMENT '是否到场 1否 2是',
  `note` varchar(64) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='用户报名登记表\r\n';

-- ----------------------------
-- Records of act_user_record
-- ----------------------------
INSERT INTO `act_user_record` VALUES ('162409c5a8693e853d41b725c6a28279', '8ce38acaf98e4781a1027f1235563860', 'f578d768c35110563ec3c9bec0c522bb', '0', '2', 'jeecg', 'f578d768c35110563ec3c9bec0c522bb', '2019-09-18 15:49:45', '2019-09-18 17:20:57', '0', '1', '');
INSERT INTO `act_user_record` VALUES ('35eb71228a5a4e1d47422b68690665a3', 'b1bbbfb4542e46faafb4b59de0682ae2', 'f578d768c35110563ec3c9bec0c522bb', '0', '2', 'jeecg', 'f578d768c35110563ec3c9bec0c522bb', '2019-09-17 18:06:51', '2019-09-17 18:08:33', '0', '1', '');
INSERT INTO `act_user_record` VALUES ('98890e3deeecee8bc3e81bf2d0549eee', '0a70e5f83c5f44aea5544fe288bd392e', 'f578d768c35110563ec3c9bec0c522bb', '0', '1', 'jeecg', null, '2019-09-18 09:36:52', null, '0', '1', null);
INSERT INTO `act_user_record` VALUES ('cf2e8c2b2435d2d0615323da2dbf0a00', '75648a32824a4afe8790b83682ab88d0', '471b516b2a17faeb2f7a7786806f942b', '0', '2', 'jeecg', '471b516b2a17faeb2f7a7786806f942b', '2019-09-17 18:07:20', '2019-09-17 18:14:04', '0', '1', '杀杀杀');
INSERT INTO `act_user_record` VALUES ('d720ec376ca25239c9ca521d4ef54308', 'fd9038b350f846eeaa60179f70eda3a0', 'f578d768c35110563ec3c9bec0c522bb', '0', '2', 'jeecg', 'f578d768c35110563ec3c9bec0c522bb', '2019-09-17 18:12:40', '2019-09-17 20:22:59', '0', '1', '');
INSERT INTO `act_user_record` VALUES ('f3d107809bca4f0d159f246035f620d3', '0a70e5f83c5f44aea5544fe288bd392e', '471b516b2a17faeb2f7a7786806f942b', '0', '1', 'jeecg', null, '2019-09-18 10:09:40', null, '0', '1', null);
...
-- ----------------------------
INSERT INTO `sys_announcement_send` VALUES ('646c0c405ec643d4dc4160db2446f8ff', '93a9060a1c20e4bf98b3f768a02c2ff9', 'e9ca23d68d884d4ebb19d07889727dae', '1', '2019-08-22 10:15:39', 'admin', '2019-05-17 11:50:56', 'admin', '2019-08-22 10:15:39');
...
INSERT INTO `sys_log` VALUES ('5ff6ebf24e98f80fa0945f4d303c5ca8', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-08-21 18:29:17', null, null);
INSERT INTO `sys_log` VALUES ('35ce62bfbbbc655e90c8062a07572116', '1', '用户名: admin,登录成功！', null, null, null, '0:0:0:0:0:0:0:1', null, null, null, null, null, 'jeecg', '2019-08-22 09:15:52', null, null);
INSERT INTO `sys_log` VALUES ('053e23769631c0ec2f5e93473acfac65', '1', '用户登录失败，用户不存在！', null, null, null, '0:0:0:0:0:0:0:1', null, null, null, null, null, 'jeecg', '2019-08-22 09:33:11', null, null);
INSERT INTO `sys_log` VALUES ('e8f318d0b0fe7d40129eb98961b145e2', '1', '用户登录失败，用户不存在！', null, null, null, '0:0:0:0:0:0:0:1', null, null, null, null, null, 'jeecg', '2019-08-22 09:33:35', null, null);
INSERT INTO `sys_log` VALUES ('47b1b09e04bb048f05fbd5b9da54e40b', '1', '用户登录失败，用户不存在！', null, null, null, '0:0:0:0:0:0:0:1', null, null, null, null, null, 'jeecg', '2019-08-22 09:33:47', null, null);
INSERT INTO `sys_log` VALUES ('8db36976db95c40b027bced6558e28c1', '1', '用户登录失败，用户不存在！', null, null, null, '0:0:0:0:0:0:0:1', null, null, null, null, null, 'jeecg', '2019-08-22 09:34:37', null, null);
INSERT INTO `sys_log` VALUES ('56198f39fbeeef68567f75c2987e4625', '1', '用户名: admin,登录成功！', null, null, null, '0:0:0:0:0:0:0:1', null, null, null, null, null, 'jeecg', '2019-08-22 09:35:12', null, null);
INSERT INTO `sys_log` VALUES ('bfca80e5852caa54704e06b0a08f9092', '1', '用户名: admin,登录成功！', null, null, null, '0:0:0:0:0:0:0:1', null, null, null, null, null, 'jeecg', '2019-08-22 09:36:25', null, null);
INSERT INTO `sys_log` VALUES ('23812493a7b53a5a8da4ce63215fe510', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-08-22 10:15:08', null, null);
INSERT INTO `sys_log` VALUES ('64f059bd400ea0a0537b30b8fd31bcc1', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-08-22 10:15:13', null, null);
INSERT INTO `sys_log` VALUES ('81f3fba044f3a7d9c0439741f0a8208e', '1', '用户名: 管理员,退出成功！', null, 'admin', '管理员', '127.0.0.1', null, null, null, null, null, 'admin', '2019-08-22 10:21:17', null, null);
INSERT INTO `sys_log` VALUES ('d40035f346e7a254b19a2f0ba3c56e9e', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-08-22 10:21:17', null, null);
INSERT INTO `sys_log` VALUES ('926ea9dbc4ddcbe31a04cf0cd860db62', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-08-22 10:21:21', null, null);
INSERT INTO `sys_log` VALUES ('dfa1dc071bf701a32a456b85d2f41c6f', '2', '活动事项表-分页列表查询', null, null, null, '0:0:0:0:0:0:0:1', 'org.jeecg.modules.act.controller.ActDictController.queryPageList()', null, null, null, '91', 'jeecg', '2019-09-04 17:15:46', null, null);
INSERT INTO `sys_log` VALUES ('4cac8aeeb675269738ff5dc377ca2b92', '2', '活动事项表-分页列表查询', null, null, null, '0:0:0:0:0:0:0:1', 'org.jeecg.modules.act.controller.ActDictController.queryPageList()', null, null, null, '2', 'jeecg', '2019-09-04 17:16:00', null, null);
INSERT INTO `sys_log` VALUES ('a98ce4081c43ecdfb911a730be216666', '2', '活动事项表-分页列表查询', null, null, null, '0:0:0:0:0:0:0:1', 'org.jeecg.modules.act.controller.ActDictController.queryPageList()', null, null, null, '3', 'jeecg', '2019-09-04 17:16:38', null, null);
INSERT INTO `sys_log` VALUES ('dfa3aa4a8e0138fe2361fe769961a7a2', '2', '活动事项表-分页列表查询', null, null, null, '0:0:0:0:0:0:0:1', 'org.jeecg.modules.act.controller.ActDictController.queryPageList()', null, null, null, '3', 'jeecg', '2019-09-04 17:16:54', null, null);
INSERT INTO `sys_log` VALUES ('f4f5ef4323f1934c9386ebf2f22e0597', '2', '活动事项表-分页列表查询', null, null, null, '0:0:0:0:0:0:0:1', 'org.jeecg.modules.act.controller.ActDictController.queryPageList()', null, null, null, '81', 'jeecg', '2019-09-04 17:17:33', null, null);
INSERT INTO `sys_log` VALUES ('ca9b54407df1086b7d4a07d3196704f5', '2', '活动事项表-分页列表查询', null, null, null, '0:0:0:0:0:0:0:1', 'org.jeecg.modules.act.controller.ActDictController.queryPageList()', null, null, null, '90', 'jeecg', '2019-09-04 17:18:52', null, null);
INSERT INTO `sys_log` VALUES ('70d687dcdc9ac253b5470dca5207376d', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-04 17:29:33', null, null);
INSERT INTO `sys_log` VALUES ('3c31726429d06d45326c07b896ffebf3', '1', '用户名: 管理员,退出成功！', null, 'admin', '管理员', '127.0.0.1', null, null, null, null, null, 'admin', '2019-09-04 17:45:35', null, null);
INSERT INTO `sys_log` VALUES ('70beabaf492cdc69ef671aaf0b187a4e', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-04 17:45:43', null, null);
INSERT INTO `sys_log` VALUES ('26ea2a3a5b86d9af95a3c5026c9dd1f2', '2', '小程序用户-分页列表查询', null, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.act.controller.ActUserController.queryPageList()', null, null, null, '91', 'admin', '2019-09-04 17:46:46', null, null);
INSERT INTO `sys_log` VALUES ('c21200d6373a687925b111f3a6faf377', '2', '小程序用户-分页列表查询', null, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.act.controller.ActUserController.queryPageList()', null, null, null, '5', 'admin', '2019-09-04 17:46:54', null, null);
INSERT INTO `sys_log` VALUES ('b221159317edfc4874667de0eb10ade4', '2', '小程序用户-分页列表查询', null, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.act.controller.ActUserController.queryPageList()', null, null, null, '17', 'admin', '2019-09-04 17:47:18', null, null);
INSERT INTO `sys_log` VALUES ('3aeee57c93e76ddfa11016128f34451d', '2', '活动分享表-分页列表查询', null, null, null, '127.0.0.1', 'org.jeecg.modules.act.controller.ActShareController.queryPageList()', null, null, null, '15', 'jeecg', '2019-09-04 17:48:55', null, null);
INSERT INTO `sys_log` VALUES ('ba6077f0dba98c2f4c1337a170ad712a', '1', '用户名: admin,登录成功！', null, null, null, '192.168.27.6', null, null, null, null, null, 'jeecg', '2019-09-04 18:05:57', null, null);
INSERT INTO `sys_log` VALUES ('3bc4c396c70766136459ec72daed8b9a', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-04 18:08:22', null, null);
INSERT INTO `sys_log` VALUES ('aba5084ab0071263ffec9814c46354fc', '2', '小程序用户-分页列表查询', null, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.act.controller.ActUserController.queryPageList()', null, null, null, '206', 'admin', '2019-09-04 18:08:26', null, null);
INSERT INTO `sys_log` VALUES ('ae66905a832ef50d503dadc992743a29', '2', '活动分享表-分页列表查询', null, null, null, '127.0.0.1', 'org.jeecg.modules.act.controller.ActShareController.queryPageList()', null, null, null, '9', 'jeecg', '2019-09-04 18:08:27', null, null);
INSERT INTO `sys_log` VALUES ('016285699ebe19ab5707bff31a668169', '2', '小程序用户-分页列表查询', null, null, null, '0:0:0:0:0:0:0:1', 'org.jeecg.modules.act.controller.ActUserController.queryPageList()', null, null, null, '158', 'jeecg', '2019-09-05 09:50:29', null, null);
INSERT INTO `sys_log` VALUES ('765b96e21a6dd89657784c729ef37136', '2', '小程序用户-分页列表查询', null, null, null, '0:0:0:0:0:0:0:1', 'org.jeecg.modules.act.controller.ActUserController.queryPageList()', null, null, null, '101', 'jeecg', '2019-09-05 09:58:01', null, null);
INSERT INTO `sys_log` VALUES ('c739d99528401f55f2332f0c1d295e84', '2', '活动事项表-分页列表查询', null, null, null, '0:0:0:0:0:0:0:1', 'org.jeecg.modules.act.controller.ActDictController.queryPageList()', null, null, null, '446', 'jeecg', '2019-09-06 11:00:39', null, null);
INSERT INTO `sys_log` VALUES ('ab743a7c2ef47e643a8e93b61527296c', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-09 16:33:25', null, null);
INSERT INTO `sys_log` VALUES ('09a3bcc8323c3eb3f92d1dc346f5c953', '2', '小程序用户-分页列表查询', null, null, null, '127.0.0.1', 'org.jeecg.modules.act.controller.ActUserController.queryPageList()', null, null, null, '265', 'jeecg', '2019-09-09 16:34:02', null, null);
INSERT INTO `sys_log` VALUES ('19c0cca7a4c02af70c9af930dcd85f30', '2', '活动分享表-分页列表查询', null, null, null, '127.0.0.1', 'org.jeecg.modules.act.controller.ActShareController.queryPageList()', null, null, null, '52', 'jeecg', '2019-09-09 16:34:02', null, null);
INSERT INTO `sys_log` VALUES ('f0a0d9e4dbab62cc08bc225f84b6522f', '1', '用户名: 管理员,退出成功！', null, 'admin', '管理员', '127.0.0.1', null, null, null, null, null, 'admin', '2019-09-09 16:34:09', null, null);
...
INSERT INTO `sys_permission` VALUES ('1823f69499b3787a3d22b01325f13123', null, '活动分享', '/act/ActShareList', 'act/ActShareList', null, null, '0', null, '1', '11', '0', 'fullscreen', '1', '1', '0', '0', null, 'admin', '2019-09-04 17:48:34', null, null, '0', '0', '1');
...
INSERT INTO `sys_permission` VALUES ('3407bbc7fc8bf3eab80608ea6d18bf73', '', '小程序用户', '/act/ActUserList', 'act/ActUserList', null, null, '0', null, '1', '10', '0', 'smile', '1', '1', '0', '0', null, 'admin', '2019-09-04 17:45:13', 'admin', '2019-09-04 17:47:13', '0', '0', '1');
...
INSERT INTO `sys_role_permission` VALUES ('3e8966070af8d45ef9f196fe7e67bdc6', 'f6817f48af4fb3af11b9e8bf182f618b', '1823f69499b3787a3d22b01325f13123', null);
...
INSERT INTO `sys_role_permission` VALUES ('594498e03f410400e336ae8d82c9ef7a', 'f6817f48af4fb3af11b9e8bf182f618b', '3407bbc7fc8bf3eab80608ea6d18bf73', null);
...
-- Records of sys_sms
-- ----------------------------
INSERT INTO `sys_sms` VALUES ('1164362490769395713', '催办：HR审批', '1', '', '{\"taskName\":\"HR审批\",\"userName\":\"admin\"}', 'admin，您好！\r\n请前待办任务办理事项！HR审批\r\n\r\n\r\n===========================\r\n此消息由系统发出', '2019-08-22 10:23:45', '0', '0', null, null, 'admin', '2019-08-22 10:23:45', null, null);
...
-- ----------------------------
-- Event structure for delete record
-- ----------------------------
DROP EVENT IF EXISTS `delete record`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` EVENT `delete record` ON SCHEDULE EVERY 5 HOUR STARTS '2019-09-18 17:43:53' ON COMPLETION NOT PRESERVE ENABLE DO DELETE FROM act_form_id WHERE
TIMESTAMPDIFF(HOUR,create_time,now()) > 168
;;
DELIMITER ;
